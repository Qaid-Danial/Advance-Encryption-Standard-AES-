...
var (
	...
	invesersBox = [16][16]string{
		...
		{"17", "2B", "04", "7E", "BA", "77", "D6", "26", "14", "69", "14", "63", "55", "21", "0C", "7D"},
	}
)

func hexToDecimal(a string) []int {
	...
	for _, element := range a {
		...
		switch {
		case element == 'a':
			decimalArray = append(decimalArray, 10)
		case element == 'b':
			decimalArray = append(decimalArray, 11)
		case element == 'c':
			decimalArray = append(decimalArray, 12)
		case element == 'd':
			decimalArray = append(decimalArray, 13)
		case element == 'e':
			decimalArray = append(decimalArray, 14)
		case element == 'f':
			decimalArray = append(decimalArray, 15)
		default:
			decimalArray = append(decimalArray, intElement)
		}
	}
